...
func (*ID) Descriptor() ([]byte, []int) {
	return fileDescriptor_proxy_7c401a969a724b9d, []int{0}
}
...
func (*ProxyMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_proxy_7c401a969a724b9d, []int{1}
}
...
func init() {
	proto.RegisterFile("examples/proxy/messages/proxy.proto", fileDescriptor_proxy_7c401a969a724b9d)
}

var fileDescriptor_proxy_7c401a969a724b9d = []byte{
