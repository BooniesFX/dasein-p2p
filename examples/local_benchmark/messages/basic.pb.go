...
func (*BasicMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_basic_11ea152882ccb943, []int{0}
}
...
func init() {
	proto.RegisterFile("examples/local_benchmark/messages/basic.proto", fileDescriptor_basic_11ea152882ccb943)
}

var fileDescriptor_basic_11ea152882ccb943 = []byte{
