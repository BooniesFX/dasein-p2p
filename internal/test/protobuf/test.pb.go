...
func (*TestMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_955c06d60c96bff2, []int{0}
}
...
func init() {
	proto.RegisterFile("internal/test/protobuf/test.proto", fileDescriptor_test_955c06d60c96bff2)
}

var fileDescriptor_test_955c06d60c96bff2 = []byte{
