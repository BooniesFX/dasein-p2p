//go:generate mockgen -destination=mocks/mock_signature_policy.go -package=mocks github.com/daseinio/dasein-p2p/crypto SignaturePolicy
//go:generate mockgen -destination=mocks/mock_hash_policy.go -package=mocks github.com/daseinio/dasein-p2p/crypto HashPolicy
